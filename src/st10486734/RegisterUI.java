...
public class RegisterUI extends javax.swing.JFrame {
   ...
   String phoneSetter(String phone) {
       /*    
             the reg expression was generated by chatGPT
             prompt: "generate reg expression to validate a phone numbe here are conditions includes a country code, followed by no more than 10 digits."
             respond:"^\\+\\d{1,4}\\s?\\d{1,10}$"
             
       */
        String phonePattern = "^\\+\\d{1,4}\\s?\\d{1,10}$";//(OpenAI,2025)
